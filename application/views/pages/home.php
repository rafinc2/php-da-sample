    ...
    <div class="carousel-inner">
        <div class="item" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                ...
                <p> Do a Kick Flip or some serious Technical Skating on Motion Board 9999-B37X-9</p>
            </div>
        </div>
        <div class="item" onclick="location.href='<?php echo base_url();?>product'">
        ...
        <div class="item active" onclick="location.href='<?php echo base_url();?>product'">
            ...
            <div class="carousel-caption">
                <h3>Pro Skate Board Motion 9999-B37X-9</h3>
                <p> Do all your cool stuff on Contoso board Motion 9999-B37X-9.</p>
            </div>
        </div>
    </div>
<!-- Controls -->
